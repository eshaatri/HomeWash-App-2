...
export const SlotSelectionScreen: React.FC<NavigationProps> = ({ navigateTo, isPremium }) => {
    ...
    <div className="bg-[#f8f7f6] dark:bg-[#171612] text-slate-900 dark:text-white font-display antialiased min-h-screen flex flex-col">
      ...
      <footer className="fixed bottom-0 left-0 right-0 max-w-md mx-auto w-full bg-white dark:bg-[#171612] border-t border-gray-200 dark:border-white/10 p-5 z-40 pb-8 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        ...
        <button 
          ...
          className="w-full bg-primary hover:brightness-110 text-[#171612] font-bold text-lg py-4 rounded-xl shadow-[0_4px_20px_rgba(var(--primary-r),var(--primary-g),var(--primary-b),0.3)] transition-all transform active:scale-[0.98] flex items-center justify-center gap-2 group">
          <span>{isPremium ? 'Confirm Priority Booking' : 'Add to Cart'}</span>
