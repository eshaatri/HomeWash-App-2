      ...
      <main className="flex-1 flex flex-col p-5 gap-8 pb-32">
        ...
        <section className="flex flex-col items-center text-center space-y-6 pt-2">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500 dark:text-gray-400 max-w-[280px] mx-auto leading-relaxed">
              Need assistance? Your personal concierge is ready to help you
              instantly.
            </p>
          </div>
          <button className="group relative w-full flex items-center justify-center h-14 bg-gold-gradient text-black font-semibold rounded-lg shadow-[0_0_15px_rgba(var(--primary-r),var(--primary-g),var(--primary-b),0.3)] hover:shadow-[0_0_25px_rgba(var(--primary-r),var(--primary-g),var(--primary-b),0.5)] transition-all active:scale-[0.98]">
            <span className="material-symbols-outlined mr-2 transition-transform group-hover:rotate-12">
        ...
        <section>
          <div className="flex items-center justify-between mb-3 px-1">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-gray-500">
              Active Request
            </h3>
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-sm font-medium text-slate-900 dark:text-white">
                  Order #2938 - Deluxe Wash
                </p>
                <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">
                  Technician Arriving in 5m
                </p>
              </div>
        ...
        <section className="pb-6">
          <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-gray-500 mb-3 px-1">
            Common Questions
          </h3>
            ...
            {[
              {
                ...
                a: "As a VIP member, you can reschedule any service up to 1 hour before the scheduled time without any penalty fees. It is available for all users to reschedule upto 24 hours before the scheduled time.",
              },
              {
                q: "Premium Insurance Coverage",
                a: "Your Gold subscription includes comprehensive insurance coverage up to $5,000 for any potential damages during service.",
              },
              {
                q: "Add-on Services",
                a: "You can add extra services like upholstery cleaning or window treatments directly through your concierge or during booking.",
              },
            ].map((faq, idx) => (
              <details
                key={idx}
                className="group rounded-lg bg-gray-50 dark:bg-surface-dark border border-gray-200 dark:border-white/5 open:bg-gray-100 dark:open:bg-[#2a2a2a] transition-colors duration-200"
              >
