      ...
      <div className="sticky top-0 z-50 flex items-center bg-white/90 dark:bg-black/90 backdrop-blur-md p-4 border-b border-gray-200 dark:border-gray-800 justify-between transition-colors">
        ...
        <div className="flex w-12 items-center justify-end">
          <button 
            ...
            className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 bg-transparent text-onyx dark:text-white gap-2 text-base font-bold leading-normal tracking-[0.015em] min-w-0 p-0"
          >
      ...
      <div className="space-y-4 pb-4">
          ...
          <div className="flex flex-col items-stretch justify-start rounded-xl bg-white dark:bg-[#121212] shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 overflow-hidden transition-all">
            ...
            <div className="flex w-full min-w-72 grow flex-col items-stretch justify-center gap-1 p-4">
              <div className="flex justify-between items-start">
                <p className="text-onyx dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Deep Home Cleaning</p>
        ...
        <div className="px-4 py-2 @container">
          <div className="flex flex-col items-stretch justify-start rounded-xl bg-white dark:bg-[#121212] shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 overflow-hidden transition-all">
            ...
            <div className="flex w-full min-w-72 grow flex-col items-stretch justify-center gap-1 p-4">
              <div className="flex justify-between items-start">
                <p className="text-onyx dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Kitchen Sanitization</p>
                <span className="material-symbols-outlined text-gray-400 dark:text-gray-500 text-xl">info</span>
              </div>
        ...
        <div className="px-4 py-2 @container">
          <div className="flex flex-col items-stretch justify-start rounded-xl bg-white dark:bg-[#121212] shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 overflow-hidden transition-all">
            ...
            <div className="flex w-full min-w-72 grow flex-col items-stretch justify-center gap-1 p-4">
              <div className="flex justify-between items-start">
                <p className="text-onyx dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Bathroom Sparkle</p>
                <span className="material-symbols-outlined text-gray-400 dark:text-gray-500 text-xl">info</span>
              </div>
        ...
        <div className="px-4 py-2 @container">
          <div className="flex flex-col items-stretch justify-start rounded-xl bg-white dark:bg-[#121212] shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 overflow-hidden transition-all">
            ...
            <div className="flex w-full min-w-72 grow flex-col items-stretch justify-center gap-1 p-4">
              <div className="flex justify-between items-start">
                <p className="text-onyx dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Sofa &amp; Carpet Grooming</p>
                <span className="material-symbols-outlined text-gray-500 dark:text-gray-500 text-xl">info</span>
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto p-4 bg-white/95 dark:bg-black/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] dark:shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)] z-50 transition-colors">
        <div className="flex items-center justify-between gap-4">
          <div className="flex flex-col">
            ...
            <span className="text-xl font-bold text-onyx dark:text-white">$477</span>
          </div>
          <button 
            onClick={() => navigateTo(AppScreen.CART)}
