    ...
    <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden pb-8 bg-alabaster dark:bg-onyx text-onyx dark:text-alabaster font-display antialiased transition-colors duration-300">
      ...
      <div className="flex flex-col items-center justify-center py-10">
        ...
        <div className="flex items-baseline gap-1">
          <span className="text-5xl font-light tracking-tighter text-onyx dark:text-white">$124.50</span>
        </div>
        <div className="mt-4 flex items-center gap-2 rounded-full border border-gray-200 dark:border-white/5 bg-white dark:bg-white/5 px-3 py-1">
          ...
          <span className="text-[10px] font-medium uppercase tracking-wide text-gray-500 dark:text-white/60">Service #HW-8829</span>
        </div>
      </div>
      ...
      <section className="flex-1 px-6">
        ...
        <div className="space-y-3">
          ...
          <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 dark:border-white/10 p-4 text-xs font-medium text-gray-500 dark:text-white/40 transition-colors hover:border-primary dark:hover:border-white/20 hover:text-primary dark:hover:text-white/60">
      ...
      <div className="mt-auto px-6 pt-8">
        ...
        >
          <span className="relative z-10 text-base font-bold text-white dark:text-onyx">Pay $124.50</span>
