      ...
      <div className="relative px-6 pt-8 pb-12 overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tighter leading-[1.1]">
            Upgrade your <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ffd633] to-[#b39624]">
              Lifestyle.
            </span>
          </h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-xs mx-auto">
            Join the exclusive club of homeowners who enjoy priority service and
            unmatched savings.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 space-y-6">
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            <h4 className="text-lg font-bold text-onyx dark:text-white">
              Flat 10% Off
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mt-1">
              Save instantly on every service, cleaning agent, and add-on. No
              minimum order value.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mt-1">
              Get exclusive access to high-demand morning and weekend slots
      ...
      <div className="fixed bottom-[84px] md:bottom-8 left-0 right-0 px-6 z-40 max-w-md mx-auto pointer-events-none">
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-center gap-3 h-full">
            <span
              className={`text-lg font-bold ${isPremium ? "text-white" : "text-white dark:text-black group-hover:text-black"}`}
            >
              {isPremium ? "Manage Membership" : "Unlock Gold @ ₹499"}
            </span>
            {!isPremium && (
              <span className="material-symbols-outlined text-white dark:text-black group-hover:text-black">
                arrow_forward
              </span>
            )}
          </div>
