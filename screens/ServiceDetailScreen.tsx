...
export const ServiceDetailScreen: React.FC<NavigationProps> = ({ navigateTo, selectedService, addToCart }) => {
    ...
    const KITCHEN_OPTS: ConfigOption[] = [
        ...
        { id: 'int', label: 'Cabinet interior with utensil arrangement', price: 499 },
        { id: 'chim', label: 'Chimney', price: 399 },
    ];

    const SOFA_OPTS: ConfigOption[] = [
        { id: 'dry', label: 'Dry vacuuming', price: 0, description: 'Basic dust removal' },
        { id: 'mat', label: 'Mattress shampoo', price: 439, description: 'per bed' },
        { id: 'wet_34', label: 'Sofa wet shampoo', price: 449, description: '3/4 seater' },
        { id: 'wet_56', label: 'Sofa wet shampoo', price: 649, description: '5/6 seater' },
        { id: 'wet_7plus', label: 'Sofa wet shampoo', price: 849, description: '7+ seater' },
    ];
    ...
    const INCLUDED_ITEMS = [
        ...
        { label: 'Doors, windows & mirrors', image: 'https://images.unsplash.com/photo-1516455590571-18256e5bb9ff?auto=format&fit=crop&q=80&w=300' },
        { label: 'Switch board & fixtures', image: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&q=80&w=300' },
        { label: 'Kitchen sink area, tiles & slabs', image: 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?auto=format&fit=crop&q=80&w=300' },
        { label: 'Stove & kitchen appliances*', image: 'https://images.unsplash.com/photo-1556910103-1c02745a30bf?auto=format&fit=crop&q=80&w=300' },
        { label: 'Cabinet exterior & interior*', image: 'https://images.unsplash.com/photo-1556912173-3db496beee71?auto=format&fit=crop&q=80&w=300' },
        { label: 'Bathroom floor scrubbing', image: 'https://images.unsplash.com/photo-1620626011761-996317b8d101?auto=format&fit=crop&q=80&w=300' },
        { label: 'Toilet seat & fixtures', image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=300' },
        { label: 'Balcony', image: 'https://images.unsplash.com/photo-1560185007-cde436f6a4d0?auto=format&fit=crop&q=80&w=300' },
    ];
    ...
    const EQUIPMENTS = [
        ...
        { label: 'Wiper', image: 'https://images.unsplash.com/photo-1517154238510-720610f43887?auto=format&fit=crop&q=80&w=200' },
        { label: 'Dusting broomstick', image: 'https://images.unsplash.com/photo-1585514022832-6a161f36473e?auto=format&fit=crop&q=80&w=200' },
    ];

    const BATHROOM_EQUIPMENTS = [
        { label: 'Buffing machine', image: 'https://images.unsplash.com/photo-1581578731117-104f2a412c54?auto=format&fit=crop&q=80&w=200' },
        { label: 'Microfibre cloths', image: 'https://images.unsplash.com/photo-1516766453986-e8d19760775d?auto=format&fit=crop&q=80&w=200' },
        { label: 'Sponge', image: 'https://images.unsplash.com/photo-1533561052604-c3be19d755f7?auto=format&fit=crop&q=80&w=200' },
        { label: 'Cleaning solutions', image: 'https://images.unsplash.com/photo-1628191010210-a59de33e5941?auto=format&fit=crop&q=80&w=200' },
        { label: 'Fine brushes', image: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?auto=format&fit=crop&q=80&w=200' },
        { label: 'Wiper', image: 'https://images.unsplash.com/photo-1517154238510-720610f43887?auto=format&fit=crop&q=80&w=200' },
    ];
    ...
    const [selectedBathroomOption, setSelectedBathroomOption] = useState<BathroomOption>(BATHROOM_OPTS[0]);
    ...
    useEffect(() => {
        if (isBathroomService) {
            setTotalPrice(selectedBathroomOption.price);
        } else {
    ...
    }, [selectedSize, kitchenSelection, addOns, selectedBathroomOption, isBathroomService]);
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-[#050505] font-display text-onyx dark:text-white pb-32">
            ...
            <div className="sticky top-0 z-40 bg-white dark:bg-[#121212] flex items-center justify-between p-4 shadow-sm border-b border-gray-100 dark:border-white/5">
                <button onClick={() => navigateTo(AppScreen.SERVICE_SELECTION)} className="material-symbols-outlined">arrow_back</button>
                <div className="flex-1 text-center pr-6">
                    <h1 className="font-bold text-lg truncate">{selectedService.title}</h1>
                </div>
                <button onClick={() => navigateTo(AppScreen.HOME)} className="material-symbols-outlined text-gray-400">close</button>
            </div>
            ...
            <div className="p-4 space-y-6">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                        <span className="material-symbols-outlined text-sm text-[#7c3aed] fill-1" style={{ fontVariationSettings: "'FILL' 1" }}>stars</span>
                        <span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.80 (4.3M reviews)</span>
                    </div>
                    {isBathroomService && (
                         <div className="flex items-center gap-1.5 mt-2 text-[#16a34a]">
                            ...
                            <span className="text-xs font-bold">Add more & save up to 15%</span>
                        </div>
                    )}
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[10px] text-gray-500">(₹{Math.round(opt.price/opt.count)}/bathroom)</p>
                                            <p className="text-[10px] font-bold text-[#16a34a] mt-1">15% off</p>
                                        </div>
                                        ...
                                        {isSelected ? (
                                            <div className="flex items-center justify-between bg-[#F3E8FF] dark:bg-[#9333EA]/20 rounded-lg h-9 px-1">
                                                ...
                                                <span className="text-sm font-bold text-[#9333EA]">1</span>
                                                <button className="w-8 flex items-center justify-center text-[#9333EA] opacity-50 cursor-default">
                    ...
                    <>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4">
                                <div className="bg-gray-100 dark:bg-white/10 h-6 w-6 flex items-center justify-center rounded text-xs font-bold text-gray-500">1</div>
                                ...
                                {SIZES.map(size => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="text-xs font-medium opacity-70">₹{size.price.toLocaleString()}</div>
                                        </button>
                                    );
                                })}
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="bg-gray-100 dark:bg-white/10 h-6 w-6 flex items-center justify-center rounded text-xs font-bold text-gray-500">2</div>
                                    <h4 className="font-bold text-sm">Kitchen cabinets & appliances*</h4>
                                </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="bg-gray-100 dark:bg-white/10 h-6 w-6 flex items-center justify-center rounded text-xs font-bold text-gray-500">3</div>
                                    <h4 className="font-bold text-sm">Sofa & mattress*</h4>
                                </div>
                                <span className="material-symbols-outlined text-gray-400 text-sm">keyboard_arrow_up</span>
                            </div>
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`snap-start min-w-[150px] w-[150px] p-3 rounded-xl border shrink-0 flex flex-col justify-between h-[140px] bg-white dark:bg-[#1a1a1a] ${
                                                hasQty ? 'border-[#9333EA] ring-1 ring-[#9333EA]' : 'border-gray-200 dark:border-white/10'
                                            }`}
                                        >
                                            <div>
                                                <div className="font-bold text-sm mb-1 leading-tight line-clamp-2">{opt.label}</div>
                                                {opt.description && <div className="text-[10px] text-gray-500 mb-2 truncate">({opt.description})</div>}
                                            ...
                                            <div className="mt-2">
                                                {qty === 0 ? (
                                                    ...
                                                    <div className="flex items-center justify-between bg-[#F3E8FF] dark:bg-[#9333EA]/20 rounded-lg h-8 px-1">
                                                        <button onClick={() => decrementAddOn(opt.id)} className="w-8 flex items-center justify-center text-[#9333EA]">
                                                            <span className="material-symbols-outlined text-sm font-bold">remove</span>
                                                        </button>
                                                        <span className="text-xs font-bold text-[#9333EA]">{qty}</span>
                                                        <button onClick={() => incrementAddOn(opt.id)} className="w-8 flex items-center justify-center text-[#9333EA]">
                                                            <span className="material-symbols-outlined text-sm font-bold">add</span>
                                                        </button>
                                                    </div>
                                                )}
                        ...
                        <div className="flex items-center justify-between pb-4">
                            <div className="flex items-center gap-4">
                                <div className="bg-gray-100 dark:bg-white/10 h-6 w-6 flex items-center justify-center rounded text-xs font-bold text-gray-500">4</div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {INCLUDED_ITEMS.map((item, idx) => (
                                    <div key={idx} className="bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-white/10 rounded-xl overflow-hidden flex flex-col h-36 shadow-sm">
                                        <div className="p-3 pb-0 flex-1">
                                            <p className="text-[11px] font-bold leading-tight text-onyx dark:text-gray-200 line-clamp-3">{item.label}</p>
                                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2 snap-x">
                                    {NEEDED_ITEMS.map((item, i) => (
                                        <div key={i} className="snap-start min-w-[120px] bg-gray-50 dark:bg-[#1a1a1a] rounded-xl p-4 flex flex-col items-center justify-center text-center gap-3 border border-gray-100 dark:border-white/5">
                                            <span className="material-symbols-outlined text-3xl text-gray-700 dark:text-gray-300">{item.icon}</span>
                ...
                <div className="space-y-4">
                    ...
                    <div className={`grid ${isBathroomService ? 'grid-cols-3' : 'grid-cols-2'} gap-4`}>
                        {(isBathroomService ? BATHROOM_EQUIPMENTS : EQUIPMENTS).map((item, i) => (
                            <div key={i} className="flex flex-col items-center text-center gap-2">
                                <div className="w-full aspect-square bg-white dark:bg-[#1a1a1a] rounded-xl p-4 flex items-center justify-center border border-gray-100 dark:border-white/5 shadow-sm">
                                    <img src={item.image} alt={item.label} className="w-full h-full object-contain p-2" />
                                </div>
