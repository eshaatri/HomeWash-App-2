...
export const ServiceDetailScreen: React.FC<NavigationProps> = ({ navigateTo, selectedService, addToCart }) => {
    ...
    useEffect(() => {
        ...
        setTotalPrice(total);
    }, [selectedSize, kitchenSelection, addOns]);
    ...
    const handleDone = () => {
        // Construct a custom service object to represent this specific configuration
        const customTitle = `${selectedService.title} (${selectedSize.label})`;
        ...
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-[#050505] font-display text-onyx dark:text-white pb-32">
            ...
            <div className="p-4 space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 font-bold mt-1">Starts at ₹{selectedService.price} • {selectedService.duration}</p>
                </div>
