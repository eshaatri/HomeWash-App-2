...
export const PartnerDashboardScreen: React.FC<NavigationProps> = ({ navigateTo, logout }) => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-[#121212] font-display text-onyx dark:text-white pb-safe">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-medium">{MOCK_PARTNER.rating} Rating</span>
                    </div>
                </div>
            </div>
            <button 
      ...
      <div className="px-4 mb-6">
        <h3 className="text-sm font-bold uppercase tracking-wide text-gray-500 mb-3">Active Job</h3>
        <div className="bg-primary text-black rounded-xl p-5 shadow-lg relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-10">
                <span className="material-symbols-outlined text-6xl">navigation</span>
            </div>
            <div className="relative z-10">
                <div className="flex justify-between items-start mb-4">
                    <div>
                        <span className="bg-black/20 text-xs font-bold px-2 py-1 rounded uppercase">En Route</span>
      ...
      <div className="px-4 flex-1">
        <div className="flex items-center justify-between mb-3">
             <h3 className="text-sm font-bold uppercase tracking-wide text-gray-500">New Leads (2)</h3>
        ...
        <div className="space-y-3">
            {[1, 2].map(i => (
                <div key={i} className="bg-white dark:bg-[#1a1a1a] p-4 rounded-xl border border-gray-100 dark:border-white/5">
                    ...
                    <div className="flex gap-2">
                        <button className="flex-1 border border-gray-200 dark:border-white/20 py-2 rounded-lg text-sm font-bold">Reject</button>
                        <button className="flex-1 bg-green-500 text-white py-2 rounded-lg text-sm font-bold shadow-lg shadow-green-500/20">Accept</button>
                    </div>
                </div>
            ))}
        </div>
